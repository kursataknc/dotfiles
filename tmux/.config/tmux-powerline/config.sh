...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="my_catppuccin"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/kursataknc/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/kursataknc/.mailcheckrc"
# }
...
# mode_indicator.sh {
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_NORMAL_MODE_TEXT="nor"
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_PREFIX_MODE_TEXT="pre"
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_MOUSE_MODE_TEXT="mo"
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/kursataknc/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/Users/kursataknc/.config/tmux/plugins//tmux-continuum"
# }
...
# vcs_branch.sh {
	...
	export TMUX_POWERLINE_SEG_VCS_BRANCH_GIT_SYMBOL_COLOUR="160"
...
# weather.sh {
	...
	export TMUX_POWERLINE_SEG_WEATHER_LAT="39.925533"
	export TMUX_POWERLINE_SEG_WEATHER_LON="32.866287"
# }
